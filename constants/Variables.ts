...
/** Native builds below this must update (also set Firestore appConfig/global via scripts/set-app-config.mjs). Raise after the new version is live on the App Store. */
